...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2023 a las 19:56:22
...
(1, 'Leonardo Saínos Pérez', 'LeonardoSainos', 'leonardosainos@gmail.com', '5e8667a439c68f5145dd2fcbecf02209', 2505, 4046, '2228412398', '2023-02-21 15:43:55', 19231),
...
(65, '2023-03-15 05:34:35', 'TK13N37', 'Tóner', 'Toner para impresora DCP-LC5650DN', 'Pendiente', 29, 2523, 94575, 1, '2023-03-27 20:06:51'),
...
--
ALTER TABLE `registro_alteraciones`
  MODIFY `id_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=486;
...
--
ALTER TABLE `user_delete`
  MODIFY `folio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
