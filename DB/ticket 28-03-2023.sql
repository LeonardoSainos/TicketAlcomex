...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-03-2023 a las 08:15:15
...
(1, '2023-03-27 14:40:38', 5, 'Andrés Sebastián Sánchez Cortez', 4046, 2505, 5, 0, 1, 2);
...
ALTER TABLE `user_delete`
  ...
  ADD KEY `Fk_depadelete` (`id_departamento`);
...
--
ALTER TABLE `registro_alteraciones`
  MODIFY `id_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=368;
...
--
ALTER TABLE `user_delete`
  ADD CONSTRAINT `Fk_depadelete` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`idDepartamento`),
