                    ...
                    <div class="col-md-12">
                        ...
                        <nav aria-label="Page navigation" class="text-center">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./tecni.php?view=tec&pagina=<?php echo $pagina-1; ?>" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                <?php endif; ?>                               
                                <?php
                                    for($i=1; $i <= $numeropaginas; $i++ ){
                                        if($pagina == $i){
                                            echo '<li class="active"><a href="./tecni.php?view=tec&pagina='.$i.'">'.$i.'</a></li>';
                                        }else{
                                            echo '<li><a href="./tecni.php?view=tec&pagina='.$i.'">'.$i.'</a></li>';
                                        }
                                    }
                                ?>
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./tecni.php?view=users&pagina=<?php echo $pagina+1; ?>" aria-label="Previous">
                                            <span aria-hidden="true">&raquo;</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
...
$("#mt").click(BuscarUsuario);
    function BuscarUsuario(){
         var URL = "./tecni.php?view=searchUsers&tec=" + $("#busqueda").val();                    
